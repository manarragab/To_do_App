...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar.homeAppBar("Home" ,
      login: login,
    ...
    onPressProfile: (){
      ...
      GetBuilder<CrudController>(builder: (_){
              ...
              return ListView(
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(Status.values.length, (index) {
                  ...
                  if (controller.currentIndex == 0)
                   ...
                   ...List.generate(
                        ...
                        (index) => Container(
                              child: CustomCard(
                                priority:crudController.tasks[index].priority??"" ,
                                desc:  crudController.tasks[index].desc??"",
                                title: crudController.tasks[index].title??"",
                               //  path: crudController.tasks[index].image,
                               status: crudController.tasks[index].status??"",
                               date:crudController.tasks[index].createdAt?.substring(0, 10)??"" ,
