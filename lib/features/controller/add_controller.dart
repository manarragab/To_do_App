...
class AddController extends GetxController {
  ...
  /// Fills the alarm details from the received arguments.
  ///
  /// This function checks if the arguments passed are of type [Alarms].
  /// If so, it switches to edit mode, updates the [titleController] and
  /// [descController] with the alarm details, and initializes the
  /// [addAlarmModel] with these details.
  void fillAlarm() {
